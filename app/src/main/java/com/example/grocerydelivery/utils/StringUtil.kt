//Citation: Starter kit from Google -  https://github.com/googlemaps/codelab-places-101-android-kotlin/blob/main/solution/app/src/main/java/com/google/codelabs/maps/placesdemo/StringUtil.kt
